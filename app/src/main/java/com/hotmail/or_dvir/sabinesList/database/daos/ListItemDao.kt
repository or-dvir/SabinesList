...
import com.hotmail.or_dvir.sabinesList.database.entities.ListItemEntity.Companion.COLUMN_ITEM_ID
...
interface ListItemDao {
    @Query("SELECT * FROM $TABLE_NAME WHERE $COLUMN_ITEM_ID = :itemId")
